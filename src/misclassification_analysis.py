...
def quick_misclassification_analysis(experiment_results, X_test, y_test, feature_names=None):
    """
    Quick analysis function that works with experiment results only
    ...
    # Filter valid results and create synthetic models
    valid_results = {}
    synthetic_models = {}
    ...
    for model_key, metrics in experiment_results.items():
        if isinstance(metrics, dict) and 'accuracy' in metrics:
            ...
            # Create synthetic model for analysis
            ...
            synthetic_models[model_key] = SyntheticModel(metrics['accuracy'])

    if not synthetic_models:
        print("❌ No valid model results found")
        return None

    # Run analysis with synthetic models
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("This module provides deep analysis of misclassified examples to understand model limitations.")
    print("\n📋 Key Features:")
    print("✅ Feature-level analysis of misclassification patterns")
    print("✅ Prediction confidence analysis")
    print("✅ Statistical significance testing")
    print("✅ Comprehensive visualizations")
    print("✅ Detailed text reports with recommendations")
    print("✅ Export capabilities for further analysis")
    print("\n💡 Usage:")
    example_usage()
    print("\n🚀 Ready to analyze your model limitations!")